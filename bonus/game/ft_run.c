...
/*   Updated: 2024/03/05 13:56:45 by souchane         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	imgsesss(t_game *game, int x, int y)
{
	...
	else if (game->map[game->i][game->j] == 'A')
		mlx_put_image_to_window(game->mlx,
			game->mlx_win, game->enemy, x, y);
}
